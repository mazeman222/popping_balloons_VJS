let colors = ['yellow', 'red', 'violet', 'blue', 'green'];
...
function playBallSound() {
    ...
    audio.src = 'resources/audio/pop.mp3';
    audio.play();
}
...
function startGame() {
    ...
    let loop = setInterval(function() {
        ...
        if(!gameOver && num !== total) {
            ...
            clearInterval(loop);
            totalShadow.style.display = 'flex';           totalShadow.querySelector('.lose').style.display = 'block';
        } else {
            clearInterval(loop);
            totalShadow.style.display = 'flex';           totalShadow.querySelector('.win').style.display = 'block';
        }
    }, 800 + timeout);
}
